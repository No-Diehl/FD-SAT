 ...
 * solving library.
 */
IPASIR_API const char * ipasir_signature (){return "nothing";}
 ...
 * State after: INPUT
 */
IPASIR_API void * ipasir_init (){return 0;}
 ...
 */
IPASIR_API int ipasir_solve (void * solver){exit(0); return 20;} // always unsat
 ...
 * State after: SAT
 */
IPASIR_API int ipasir_val (void * solver, int lit){return 0;}
 ...
 * State after: UNSAT
 */
IPASIR_API int ipasir_failed (void * solver, int lit){return 0;}
